...
window.BOOSTERS = {
  ...
  splitTS: [
    {
      ...
      writeHint: "上方兩個面向各補一個具體細節，用英文各寫一句。細節須含人、地點、時間、數字或動作其中之一，不能只寫 it is good。",
      checks: [
        "每句都含人、地點、時間、數字或動作其中之一",
        "兩句分別對準不同面向，沒有重複",
        "沒有寫到主題句未答應的事"
      ],
      models: [
    ...
    },
    {
      ...
      writeHint: "兩個面向各補一個具體細節，用英文各寫一句。取材自你自己邊聽音樂邊念書的一次經驗。",
      checks: [
        "每句都含人、地點、時間、數字或動作其中之一",
        "兩句分別對準不同面向，沒有重複",
        "沒有寫到主題句未答應的事"
    ...
    },
    {
      ...
      note: "這一句沒有把面向列出來，但它已經圈定了範圍。先讀出範圍，再自行決定要寫哪兩個面向——寫到範圍外，內容項就會被扣分。",
      fields: [
        { k: "topic", label: "topic（你要談的主體）" },
  ...
  endings: [
    { k: "總結重點", d: "把兩段講過的事收成一句。最穩，也最容易寫成廢話——要收成一句話，不是把前面再抄一遍。" },
